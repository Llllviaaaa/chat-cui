...
| `P07-REF-01` | Reproducible reference snapshot protocol | `07-ALIGNMENT-RUNBOOK.md` section "Reference Baseline Snapshot Method" | `git clone` + baseline capture workflow from runbook | Runbook publishes required snapshot schema (`reference_repo`, `reference_tag_or_commit`, `snapshot_date_utc`, `diff_scope`) and reusable record template | `evidence_id: P07-REF-01-20260304` |
